...
void chatterCallback(const geometry_msgs::Twist::ConstPtr& msg)
{
  ...
  ROS_INFO("  cmd_vel X value recieved at Callback: [%f]", msg->linear.x); // prints x value of keyboard teleop
  window.push_back(msg->linear.x);
...
int main(int argc, char **argv)
{
  ...
  ros::Subscriber sub = n.subscribe("/turtle1/cmd_vel", 1000, chatterCallback); //subcriber to keyboard teleop
